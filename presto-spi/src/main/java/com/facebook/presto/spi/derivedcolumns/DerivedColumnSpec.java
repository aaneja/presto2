...
/**
 * This class stores the derived column information, it is serialized to JSON and embedded as part of
 * DerivedColumnSpecList into table properties of Iceberg table.
 */
public class DerivedColumnSpec
{
     ...
     * @param derivedColumnName Name of the derived column as stored in table properties.
     * @param derivedColumnFieldId Iceberg schema's field id.
