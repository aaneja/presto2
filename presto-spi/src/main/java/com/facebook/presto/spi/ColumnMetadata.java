...
public class ColumnMetadata
{
    ...
    public static Builder buildFrom(ColumnMetadata columnMetadata)
    {
        Builder builder = new Builder();
        builder.setType(columnMetadata.getType())
                .setName(columnMetadata.getName())
                .setHidden(columnMetadata.hidden)
                .setNullable(columnMetadata.nullable)
                .setComment(columnMetadata.comment)
                .setProperties(columnMetadata.properties)
                .setExtraInfo(columnMetadata.extraInfo)
                .setDerivedColumnSpec(columnMetadata.derivedColumnSpec);
        return builder;
    }
