...
columnDefinition
    : identifier type (NOT NULL)? (COMMENT string)? (DEFAULT expression)? ((GENERATED_ALWAYS)? AS expression (PERSISTENT | VIRTUAL)?)? (WITH properties)?
    ;
...
nonReserved
    ...
    | GENERATED_ALWAYS | GRANT | GRANTED | GRANTS | GRAPHVIZ | GROUPS
    | HOUR
